...
export const LOCAL_HEALTH_HOST =
  import.meta.env.VITE_LOCAL_HEALTH_HOST || "localhost";
export const LOCAL_HEALTH_PORT = import.meta.env.VITE_LOCAL_HEALTH_PORT || 3000;
export const LOCAL_HYDRA_HOST =
  import.meta.env.VITE_LOCAL_HYDRA_HOST || "localhost";
export const LOCAL_HYDRA_PORT = import.meta.env.VITE_LOCAL_HYDRA_PORT || 4001;
