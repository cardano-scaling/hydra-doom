...
INPUT=$(npx tsx src/mint-token.ts --input $INPUT#2 --tokenName 487964726120446F6F6D202D2031737420506C6163652054726F706879 --outputAddress addr1vxuzf77j35f22uhr27ynnfaa2p0c73nq8rvqhgj5dlfw23s9kz2uc --amount 25000 | tail -n 1)
