import { ProtocolParameters, SlotConfig, Evaluator } from '@blaze-cardano/core';
 ...
 */
declare function makeUplcEvaluator(params: ProtocolParameters, overEstimateSteps: number, overEstimateMem: number, slotConfig?: SlotConfig): Evaluator;
