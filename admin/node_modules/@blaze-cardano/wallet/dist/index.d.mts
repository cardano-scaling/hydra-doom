import { NetworkId, TransactionUnspentOutput, Value, Address, RewardAddress, Transaction, TransactionWitnessSet, TransactionId, HexBlob, Bip32PrivateKey, AddressType, Bip32PublicKey, Bip32PrivateKeyHex, Ed25519PrivateNormalKeyHex } from '@blaze-cardano/core';
 ...
 */
declare const WalletDetails: Wallet[];
...
export { type CIP30DataSignature, type CIP30Interface, ColdWallet, HotSingleWallet, HotWallet, type Namespace, Wallet$1 as Wallet, WalletDetails, WebWallet };
