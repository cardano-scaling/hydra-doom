import { ChainSyncError, ChainSyncErrorCode, CredentialAlreadyRegisteredData, DRepAlreadyRegisteredData, DRepNotRegisteredData, GeneralCardanoNodeError, GeneralCardanoNodeErrorCode, IncompleteWithdrawalsData, OutsideOfValidityIntervalData, StateQueryError, StateQueryErrorCode, TxSubmissionError, TxSubmissionErrorCode, UnknownCredentialData, UnknownOutputReferencesData, ValueNotConservedData } from '../types';
...
export declare const isCredentialAlreadyRegistered: (error: unknown) => error is TxSubmissionError<CredentialAlreadyRegisteredData | null>;
export declare const isDrepAlreadyRegistered: (error: unknown) => error is TxSubmissionError<DRepAlreadyRegisteredData | null>;
export declare const isUnknownCredential: (error: unknown) => error is TxSubmissionError<UnknownCredentialData | null>;
export declare const isDrepNotRegistered: (error: unknown) => error is TxSubmissionError<DRepNotRegisteredData | null>;
