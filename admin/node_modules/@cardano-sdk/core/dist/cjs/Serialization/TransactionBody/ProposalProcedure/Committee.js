...
class Committee {
    ...
    toCbor() {
        ...
        if (__classPrivateFieldGet(this, _Committee_committeeColdCredentials, "f").length === 0)
            throw new util_1.InvalidStateError('There must be at least one Committee member');
        ...
        writer.writeEncodedValue((0, misc_1.hexToBytes)(__classPrivateFieldGet(this, _Committee_quorumThreshold, "f").toCbor()));
    ...
    static fromCbor(cbor) {
        ...
        if (length !== COMMITTEE_ARRAY_SIZE)
            throw new util_1.InvalidArgumentError('cbor', `Expected an array of ${COMMITTEE_ARRAY_SIZE} elements, but got an array of ${length} elements`);
        reader.readStartMap();
        const members = [];
    ...
    static fromCore(coreCommittee) {
        const committee = new Committee(Common_1.UnitInterval.fromCore(coreCommittee.quorumThreshold));
    ...
    addMember(committeeColdCredential, epoch) {
        ...
        if (member)
            throw new util_1.InvalidArgumentError('committeeColdCredential', 'The given credential is already present');
