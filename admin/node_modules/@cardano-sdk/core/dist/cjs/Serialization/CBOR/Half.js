...
exports.encodeHalf = exports.decodeHalf = void 0;
...
exports.decodeHalf = decodeHalf;
const encodeHalf = (value) => {
    const u32 = Buffer.allocUnsafe(4);
    u32.writeFloatBE(value, 0);
    const u = u32.readUInt32BE(0);
    if ((u & 8191) !== 0) {
        throw new errors_1.LossOfPrecisionException(LOSS_OF_PRECISION_MSG);
    }
    let s16 = (u >> 16) & 32768;
    const exp = (u >> 23) & 0xff;
