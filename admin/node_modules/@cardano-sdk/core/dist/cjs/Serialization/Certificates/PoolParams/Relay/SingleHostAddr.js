...
class SingleHostAddr {
    ...
    toCbor() {
        ...
        __classPrivateFieldGet(this, _SingleHostAddr_ipV4, "f") ? writer.writeByteString((0, ipUtils_1.ipV4StringToByteArray)(__classPrivateFieldGet(this, _SingleHostAddr_ipV4, "f"))) : writer.writeNull();
        __classPrivateFieldGet(this, _SingleHostAddr_ipV6, "f") ? writer.writeByteString((0, ipUtils_1.ipV6StringToByteArray)(__classPrivateFieldGet(this, _SingleHostAddr_ipV6, "f"))) : writer.writeNull();
    ...
    static fromCbor(cbor) {
        ...
        if (id !== SINGLE_HOST_ADDR_RELAY_ID)
            throw new util_1.InvalidArgumentError('cbor', `Expected SingleHostAddr id ${SINGLE_HOST_ADDR_RELAY_ID}, but got ${id}`);
        let port;
        let ipV4;
        let ipV6;
        ...
        if (reader.peekState() === CBOR_1.CborReaderState.Null) {
            ...
            ipV4 = (0, ipUtils_1.byteArrayToIpV4String)(reader.readByteString());
        }
        if (reader.peekState() === CBOR_1.CborReaderState.Null) {
            reader.readNull();
            ipV6 = undefined;
            ...
            ipV6 = (0, ipUtils_1.byteArrayToIPv6String)(reader.readByteString());
        }
...
//# sourceMappingURL=SingleHostAddr.js.map