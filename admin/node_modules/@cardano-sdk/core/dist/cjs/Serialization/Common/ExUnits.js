...
class ExUnits {
    ...
    static fromCbor(cbor) {
        ...
        if (length !== EX_UNITS_ARRAY_SIZE)
            throw new util_1.InvalidArgumentError('cbor', `Expected an array of ${EX_UNITS_ARRAY_SIZE} elements, but got an array of ${length} elements`);
