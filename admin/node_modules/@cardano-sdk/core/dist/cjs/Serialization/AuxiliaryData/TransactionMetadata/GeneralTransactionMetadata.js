...
exports.GeneralTransactionMetadata = void 0;
const CBOR_1 = require("../../CBOR");
const util_1 = require("@cardano-sdk/util");
const TransactionMetadatum_1 = require("./TransactionMetadatum");
...
class GeneralTransactionMetadata {
    ...
    toCbor() {
        ...
        for (const [key, val] of __classPrivateFieldGet(this, _GeneralTransactionMetadata_metadata, "f").entries()) {
            writer.writeInt(key);
            writer.writeEncodedValue((0, misc_1.hexToBytes)(val.toCbor()));
        }
    ...
    static fromCbor(cbor) {
        ...
        while (reader.peekState() !== CBOR_1.CborReaderState.EndMap) {
            ...
            const metadatum = TransactionMetadatum_1.TransactionMetadatum.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()));
    ...
    static fromCore(metadata) {
        return new GeneralTransactionMetadata(new Map([...metadata.entries()].map((entry) => [entry[0], TransactionMetadatum_1.TransactionMetadatum.fromCore(entry[1])])));
    }
    metadata() {
